...
export const PLACES = [
  ...
  },
  {
    ...
    photos: [
      ...
      { src: "/images/giza-me.jpg", alt: "Erickson at Giza" },
    ],
    blog: null,
  },
  {
    ...
    photos: [
      { src: "/images/taj-mahal-1.jpg", alt: "Taj Mahal — wide from lawn" },
  ...
  },
  {
    ...
    photos: [
      { src: "/images/doha-1.jpg", alt: "Doha — skyline reflection" },
      { src: "/images/doha-2.jpg", alt: "Doha — Katara Towers" },
  ...
  },
  {
    ...
    photos: [
      { src: "/images/rio-1.jpg", alt: "Rio — sunset behind Sugarloaf" },
      { src: "/images/rio-2.jpg", alt: "Rio — Christ the Redeemer" },
      { src: "/images/travel-sunset-mountains.jpg", alt: "Sunset over Rio de Janeiro from Sugarloaf Mountain" },
      { src: "/images/rio-me.jpg", alt: "Erickson at Rio" },
    ],
    blog: null,
  },
  {
    ...
    photos: [
      { src: "/images/antarctica-1.jpg", alt: "Antarctica — iceberg, blue cave" },
  ...
  visit("Banff",             "Banff, Canada",                   "CAN", "North America",  51.1784, -115.5708),
  {
    ...
    photos: [
      { src: "/images/mexico-city-1.jpg", alt: "Mexico City — cathedral interior" },
      { src: "/images/mexico-city-2.jpg", alt: "Mexico City — Xochimilco boats" },
    ],
    blog: null,
  },
  ...
  visit("Ometepe Island",    "Ometepe Island, Nicaragua",       "NIC", "North America",  11.5000,  -85.5800),
  ...
  visit("Waipahu",           "Waipahu, Hawaiʻi, USA",           "USA", "North America",  21.3867, -158.0092),
  {
    ...
    photos: [
      { src: "/images/hilo-1.jpg", alt: "Hilo — lava coast" },
    ],
    blog: null,
  },
  ...
  visit("San Andrés Island", "San Andrés, Colombia",            "COL", "South America",  12.5847,  -81.7006),
  ...
  visit("Montevideo",        "Montevideo, Uruguay",             "URY", "South America", -34.9011,  -56.1645),
  {
    ...
    photos: [
      { src: "/images/punta-del-este-1.jpg", alt: "Punta del Este — sunset" },
      { src: "/images/punta-del-este-2.jpg", alt: "Punta del Este — sun rays" },
    ],
    blog: null,
  },
  // Europe
  ...
  visit("Stockholm",         "Stockholm, Sweden",               "SWE", "Europe",         59.3293,   18.0686, "June 2022"),
  ...
  visit("Dublin",            "Dublin, Ireland",                 "IRL", "Europe",         53.3498,   -6.2603),
  {
    ...
    photos: [
      { src: "/images/paris-1.jpg", alt: "Paris — Eiffel at night, from the Seine" },
      { src: "/images/paris-2.jpg", alt: "Paris — aerial over the Seine" },
    ],
    blog: null,
  },
  {
    ...
    photos: [
      { src: "/images/reims-me.jpg", alt: "Erickson at Reims" },
    ],
    blog: null,
  },
  ...
  visit("Prague",            "Prague, Czech Republic",          "CZE", "Europe",         50.0755,   14.4378),
  {
    ...
    photos: [
      { src: "/images/budapest-1.jpg", alt: "Budapest — Parliament, blue hour" },
      { src: "/images/budapest-2.jpg", alt: "Budapest — gilded ceiling detail" },
    ],
    blog: null,
  },
  visit("Split",             "Split, Croatia",                  "HRV", "Europe",         43.5081,   16.4402),
  visit("Belgrade",          "Belgrade, Serbia",                "SRB", "Europe",         44.7866,   20.4489, "June 2021"),
  visit("Sofia",             "Sofia, Bulgaria",                 "BGR", "Europe",         42.6977,   23.3219),
  visit("Athens",            "Athens, Greece",                  "GRC", "Europe",         37.9838,   23.7275, "June 2021"),
  ...
  visit("Dubai",             "Dubai, UAE",                      "ARE", "Asia",           25.2048,   55.2708),
  {
    ...
    photos: [
      { src: "/images/abu-dhabi-1.jpg", alt: "Abu Dhabi — Grand Mosque arches" },
      { src: "/images/abu-dhabi-2.jpg", alt: "Abu Dhabi — minaret + reflection" },
      { src: "/images/abu-dhabi-me.jpg", alt: "Erickson at Abu Dhabi" },
    ],
    blog: null,
  },
  ...
  visit("Cairo",             "Cairo, Egypt",                    "EGY", "Africa",         30.0444,   31.2357),
  {
    ...
    photos: [
      { src: "/images/hurghada-me.jpg", alt: "Erickson at Hurghada" },
    ],
    blog: null,
  },
  ...
  visit("Tokyo",             "Tokyo, Japan",                    "JPN", "Asia",           35.6762,  139.6503),
  {
    ...
    photos: [
      { src: "/images/kyoto-1.jpg", alt: "Kyoto — Kiyomizu-dera gate" },
      { src: "/images/kyoto-2.jpg", alt: "Kyoto — five-storey pagoda" },
      { src: "/images/kyoto-3.jpg", alt: "Kyoto — bamboo grove" },
      { src: "/images/kyoto-4.jpg", alt: "Kyoto — garden window" },
      { src: "/images/kyoto-me.jpg", alt: "Erickson at Kyoto" },
    ],
    blog: null,
  },
  ...
  visit("Lake Tōya",         "Lake Tōya, Hokkaido, Japan",      "JPN", "Asia",           42.5966,  140.8497),
  ...
  visit("Taipei",            "Taipei, Taiwan",                  "TWN", "Asia",           25.0330,  121.5654, "Feb 2024"),
  ...
  visit("Bangkok",           "Bangkok, Thailand",               "THA", "Asia",           13.7563,  100.5018),
  {
    ...
    photos: [
      { src: "/images/phuket-1.jpg", alt: "Phuket — Khai Nai beach" },
    ],
    blog: null,
  },
  ...
  visit("Penang",            "Penang, Malaysia",                "MYS", "Asia",            5.4141,  100.3288),
  {
    ...
    photos: [
      { src: "/images/singapore-1.jpg", alt: "Singapore — aerial Gardens by the Bay" },
      { src: "/images/singapore-2.jpg", alt: "Singapore — aerial, Marina Bay" },
    ],
    blog: null,
  },
  visit("Bali",              "Bali, Indonesia",                 "IDN", "Asia",           -8.6705,  115.2126),
  visit("Malé",              "Malé, Maldives",                  "MDV", "Asia",            4.1755,   73.5093),
  visit("Addu Atoll",        "Addu Atoll (Gan), Maldives",      "MDV", "Asia",           -0.6934,   73.1554, "April 2023"),
  ...
  visit("Mumbai",            "Mumbai, India",                   "IND", "Asia",           19.0760,   72.8777),
  {
    ...
    photos: [
      { src: "/images/leh-1.jpg", alt: "Leh, Ladakh — snow range" },
      { src: "/images/leh-2.jpg", alt: "Leh, Ladakh — golden ridge" },
    ],
    blog: null,
  },
  // Oceania
  ...
  visit("Waiheke Island",    "Waiheke Island, New Zealand",     "NZL", "Oceania",       -36.8000,  175.1000),
  {
    ...
    photos: [
      { src: "/images/rotorua-1.jpg", alt: "Rotorua — Champagne Pool" },
      { src: "/images/rotorua-2.jpg", alt: "Rotorua — green crater lake" },
      { src: "/images/rotorua-me.jpg", alt: "Erickson at Rotorua" },
    ],
    blog: null,
  },
  ...
  visit("Christchurch",      "Christchurch, New Zealand",       "NZL", "Oceania",       -43.5321,  172.6362),
  {
    ...
    photos: [
      { src: "/images/queenstown-1.jpg", alt: "Queenstown — Lake Wakatipu" },
      { src: "/images/queenstown-2.jpg", alt: "Queenstown — lake + town" },
      { src: "/images/queenstown-me.jpg", alt: "Erickson at Queenstown" },
    ],
    blog: null,
  },
